...
public class SettingsPINChange extends SherlockActivity {
	...
	public boolean onMenuItemSelected(int featureId, MenuItem item) {
		...
		Hashtable<Integer, String> kesalahan = s.checkValidPIN(oldPin, newPin, newPin2);
		
		// Jika tidak ada kesalahan, maka simpan perubahan
		if (kesalahan.size() == 0) {
			s.setPIN(newPin);
			Toast.makeText(this, R.string.setting_pin_changed, Toast.LENGTH_LONG).show();
			this.finish();
		}
